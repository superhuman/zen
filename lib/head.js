...
function openCloudWatch() {
  ...
  if (focusedResult) {
    window.open(
      `https://${aws.region}.console.aws.amazon.com/cloudwatch/home?region=${aws.region}#logEventViewer:group=/aws/lambda/zen-workTests-staging;stream=${focusedResult.logStream}`
    )
  }
}
